...
| [`kameleon-animation.schema.json`](schema/kameleon-animation.schema.json) | JSON Schema | Inline console animations for the Kameleon.Animation PowerShell module | [url](https://raw.githubusercontent.com/bilda-one/cdn-ish/refs/heads/main/schema/kameleon-animation.schema.json) |
| [`psprofiles-config.schema.json`](schema/psprofiles-config.schema.json) | JSON Schema | Named PowerShell profile configurations - modules, aliases, PSReadLine and prompt | [url](https://raw.githubusercontent.com/bilda-one/cdn-ish/refs/heads/main/schema/psprofiles-config.schema.json) |
